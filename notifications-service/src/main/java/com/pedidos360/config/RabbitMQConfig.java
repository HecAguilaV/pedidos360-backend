...
public class RabbitMQConfig {
    ...
    public static final String NOTIFICATIONS_QUEUE = "order-notifications";
    ...
    public Binding notificationsBinding(Queue notificationsQueue, TopicExchange ordersExchange) {
        return BindingBuilder.bind(notificationsQueue).to(ordersExchange).with(ROUTING_KEY_PATTERN);
    }
